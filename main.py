...
def criar():
    ...
    try:
        ...
        cursor.close()
    return redirect(url_for('usuario2'))
...
def editar(id):
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            arquivo.save(f'uploads/capa{id}.jpg')
...
def usuario2():
    ...
    cursor.execute("""
        SELECT l.id_livro, l.nome, l.autor, l.ano_publicacao
        FROM livro l
        ORDER BY l.nome ASC
    """)
    ...
    return render_template('usuario2.html', livros=livros)
